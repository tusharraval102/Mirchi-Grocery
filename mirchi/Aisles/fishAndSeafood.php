...
<head>
    ...
    <title>Mirchi Grocery | Fish and Seafood</title>
    ...
    <style>
    #splash {
        background-image: url("/imgs/splash-seafood.jpg");
    }
    </style>
</head>
...
?>
    ...
    function myFunction(xml) {
        ...
        for (i = 0; i < x.length; i++) {
            if (x[i].getAttribute('id') == "FishAndSeafood") {
                ...
                for (count = 0; count < products.length; count++) {
                    ...
                    productCard += "<div class=\"col-md-4\"><div class=\"card\"><div><img class=\"product-img\" src=" +
                        ...
                        "</span></div><div class=\"product-body\"><div class=\"product-title\"><h5><a href=\"/Aisles/fishProduct.php?sku=" +
