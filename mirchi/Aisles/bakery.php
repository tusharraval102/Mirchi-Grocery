...
<head>
    ...
    <title>Mirchi Grocery | Bakery</title>
    ...
    <style>
    #splash {
        background-image: url("/imgs/ales-krivec-QnNqGoCnBg0-unsplash.jpg");
    }
    </style>
</head>
            ...
            if (x[i].getAttribute('id') == "Bakery") {
                ...
                for (count = 0; count < products.length; count++) {
                    ...
                    productCard += "<div class=\"col-md-4\"><div class=\"card\"><div><img class=\"product-img\" src=" +
                        ...
                        "</span></div><div class=\"product-body\"><div class=\"product-title\"><h5><a href=\"/Aisles/bakeryProduct.php?sku=" +
