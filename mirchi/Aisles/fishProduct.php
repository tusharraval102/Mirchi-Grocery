...
if (isset($_SESSION['username'])) {
    ...
    echo "<a href=\"../Login/logout.php\" class=\"nav-item\">Log in</a>";
}
...
<?php
if (isset($_SESSION['username'])) {
    echo "<a href=\"../Login/login.php\" class=\"nav-item\">Log Out</a>";
}
...
?>
    ...
    <div class="container" id="product">
        <div class="back-button"><a href="/Aisles/fishAndSeafood.php">Back</a></div>
